...
// WhatsAppFAB.jsx (o dentro de App.js arriba del return)

// ====== CONFIG FÁCIL ======
const WA_CONFIG = {
  number: "573177110447", // <— cambia el número
  message: "Hola, quisiera una cotización de mobiliario de oficina.", // <— cambia el mensaje
  position: "right", // "right" | "left"
  showTextFrom: "sm", // "never" | "sm" | "md" | "lg" (desde qué breakpoint mostrar la palabra WhatsApp)
  theme: "green", // "green" | "orange" | "dark"
  size: "md", // "sm" | "md" | "lg"
};
