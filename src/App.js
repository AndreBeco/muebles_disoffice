      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 lg:h-24">
          ...
          <div className="flex items-center">
            <img
              src="https://i.pinimg.com/736x/4b/9d/c7/4b9dc7bae3ffc1d8ecbfe4ea994026dc.jpg"
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            {menuItems.map((item) => (
              <div
                key={item.id}
                className="relative"
                ref={item.id === 'servicios' ? servicesRef : null}
              >
                <button
                  ...
                  className={`text-sm font-medium transition-colors duration-200 relative group px-3 py-2 rounded flex items-center
                    ${
                      currentPage === item.id ||
                      (item.id === 'servicios' && isServiceActive)
